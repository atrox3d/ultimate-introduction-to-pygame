...
#
sky_bg = pygame.image.load('graphics/Sky.png').convert()                    # load sky background and convert it
ground_bg = pygame.image.load('graphics/ground.png').convert()              # load terrain background and convert it
#
snail = pygame.image.load('graphics/snail/snail1.png').convert_alpha()      # load snail and converting respecting alpha channel
snail_x = 600
